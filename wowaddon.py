...
BOM_NAME_CLASSIC = 'CEPGP_BulkAward'  # Directory and zip name
BOM_TITLE_CLASSIC = "CEPGP Bulk Award"  # Title field in TOC

UI_VERSION_CLASSIC_TBC = '20502'  # patch 2.5.2
BOM_NAME_CLASSIC_TBC = 'CEPGP_BulkAward'  # Directory and zip name
BOM_TITLE_CLASSIC_TBC = "CEPGP Bulk Award"  # Title field in TOC

COPY_DIRS = []
COPY_FILES = ['CEPGP_BulkAward.lua', 'README.md']
